...
const AGENT_DIR_ARGUMENT = new Argument(
  '[agents_dir]',
  'Agent file or directory of agents to serve. For directory the internal structure should be agents_dir/{agentName}.js or agents_dir/{agentName}/agent.js. Agent file should have export of the rootAgent as instance of BaseAgent (e.g LlmAgent)',
).default(process.cwd());
